                                ...
                                <div class="mt-1 flex">
                                    <div class="relative flex-grow">
                                        ...
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                            <i id="icon-preview" class="{{ old('icon', $tool->icon) }} text-gray-400"></i>
                                        </div>
                                    </div>
                                    ...
                                    @foreach($toolTypes as $type)
                                        <div class="flex items-center">
                                            <input type="checkbox" name="tool_types[]" id="tool_type_{{ $type->id }}" value="{{ $type->id }}"
                                                ...
                                                {{ in_array($type->id, old('tool_types', $selectedToolTypes)) ? 'checked' : '' }}>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <input type="text" name="translations[{{ $language->code }}][name]" id="translations_{{ $language->code }}_name" 
                                                value="{{ old("translations.{$language->code}.name", $translations[$language->code]['name'] ?? '') }}" required
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <textarea 
                                                ...
                                                class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50"
                                                required
                                                placeholder="{{ __('Description de l\'outil') }}">{{ old("translations.{$language->code}.description", $translations[$language->code]['description'] ?? '') }}</textarea>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="translations[{{ $language->code }}][meta_title]" id="translations_{{ $language->code }}_meta_title" 
                                                    value="{{ old("translations.{$language->code}.meta_title", $translations[$language->code]['meta_title'] ?? '') }}" maxlength="70"
                                                    class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50">
                                            </div>
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <textarea name="translations[{{ $language->code }}][meta_description]" id="translations_{{ $language->code }}_meta_description" rows="2" maxlength="160"
                                                    class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50">{{ old("translations.{$language->code}.meta_description", $translations[$language->code]['meta_description'] ?? '') }}</textarea>
                                            </div>
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="translations[{{ $language->code }}][custom_h1]" id="translations_{{ $language->code }}_custom_h1" 
                                                    value="{{ old("translations.{$language->code}.custom_h1", $translations[$language->code]['custom_h1'] ?? '') }}"
                                                    class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50">
                                            </div>
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                                {{ __('Laissez vide pour utiliser le nom de l\'outil') }}
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-1">
                                                <textarea name="translations[{{ $language->code }}][custom_description]" id="translations_{{ $language->code }}_custom_description" rows="2"
                                                    class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-purple-500 focus:ring focus:ring-purple-200 focus:ring-opacity-50">{{ old("translations.{$language->code}.custom_description", $translations[$language->code]['custom_description'] ?? '') }}</textarea>
                                            </div>
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                                {{ __('Laissez vide pour utiliser la description de l\'outil') }}
                                            </p>
