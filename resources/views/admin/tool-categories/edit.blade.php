        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.tool-categories.update', ['locale' => app()->getLocale(), 'tool_category' => $toolCategory->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="slug" id="slug" value="{{ old('slug', $toolCategory->slug) }}"
                                ...
                                <div class="mt-1 relative">
                                    <div class="flex items-center">
                                        <div class="relative flex-grow">
                                            <input type="text" name="icon" id="icon" value="{{ old('icon', $toolCategory->icon) }}"
                                            ...
                                            <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                                <i id="icon-preview" class="{{ old('icon', $toolCategory->icon) }} text-gray-400"></i>
                                            </div>
                                        </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="order" id="order" value="{{ old('order', $toolCategory->order) }}"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300">
                                @error('order')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $toolCategory->is_active) ? 'checked' : '' }}
                                ...
                                <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="translations[{{ $language->code }}][name]" 
                                            ...
                                            value="{{ old("translations.{$language->code}.name", $translations[$language->code]['name'] ?? '') }}"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300"
                                            required>
                                    ...
                                    <div>
                                        ...
                                        <input id="translations_{{ $language->code }}_description_hidden" 
                                              ...
                                              value="{{ old("translations.{$language->code}.description", $translations[$language->code]['description'] ?? '') }}" 
                                              required>
