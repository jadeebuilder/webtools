...
class Tools extends Controller {
    ...
    private function initiate() {
        ...
        /* Meta & title */
        Title::set(sprintf(l('tools.tool_title'), l('tools.' . \Altum\Router::$method . '.name')), true);
    ...
    public function dns_lookup() {
        ...
        if(!empty($_POST)) {
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                (new \Altum\Models\Tools())->process_usage(\Altum\Router::$method);
        ...
        if(!empty($_POST)) {
            ...
            do {
                try {
                    ...
                    $response = \Unirest\Request::get($url, [
                        'User-Agent' => settings()->main->title . ' ' . url('url-redirect-checker') . '/1.0'
                    ]);
